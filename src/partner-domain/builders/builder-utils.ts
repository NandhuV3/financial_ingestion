...
export function findTheme(themes: Theme[], keywords: string[]): Theme | undefined {
...
export function calculateConviction(artifacts: PartnerSourceArtifacts): "low" | "medium" | "high" {
  const sourceCount = [
    artifacts.themes,
    artifacts.insight,
    artifacts.narrative,
